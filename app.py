...
# 2. ఆటో-రీఫ్రెష్ సెటప్ (ప్రతి 30 సెకన్లకు యాప్ ఆటోమేటిక్‌గా సమయాన్ని చెక్ చేసుకుంటుంది)
st_autorefresh(interval=30000, key="datarefresh")

st.title("📱 ప్రశాంతి గారి AI షుగర్ కేర్ & ఆటోమేటిక్ అలారమ్ యాప్")
st.write("---")

# 3. ప్రస్తుత సమయం మరియు తేదీ
now = datetime.datetime.now()
current_time = now.strftime("%H:%M")
st.subheader(f"⏰ ప్రస్తుత సమయం: {now.strftime('%I:%M %p')}")

# 4. 9.9% HbA1c కి సరిపోయే పక్కా డైలీ టైమ్-టేబుల్ (మెడిసిన్ మరియు డైట్ అలారమ్స్)
DAILY_ALARM_ROUTINE = [
    ...
    {"time": "13:00", "title": "🥗 మధ్యాహ్న భోజనం (Lunch Time)", "msg": "భోజన సమయం! తెల్ల అన్నం (వైట్ రైస్) అస్సలు ముట్టవద్దు. 2 జొన్న రొట్టెలు, ఎక్కువ ఆకుకూరలు, వెజిటబుль సలాడ్ మాత్రమే తినండి."},
...
# 5. ఆటోమేటిక్ అలారమ్ ట్రిగ్గర్ లాజిక్
